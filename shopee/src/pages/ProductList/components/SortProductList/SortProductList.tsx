      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2 flex'>
            {page === 1 ? (
              <span className='flex h-8 w-8 cursor-not-allowed items-center justify-center rounded-tl-sm rounded-bl-sm bg-white/60 opacity-50'>
                <svg
              ...
              <Link
                ...
                className='flex h-8 w-8 cursor-pointer items-center justify-center rounded-tl-sm rounded-bl-sm bg-white hover:bg-slate-100'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
