            ...
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                <div className='flex flex-col py-2 px-3'>
                  <button className='py-2 pr-20 hover:text-orange'>Tiếng Việt</button>
                  <button className='mt-2 py-2 pr-20 hover:text-orange'>Tiếng Anh</button>
                </div>
              </div>
            }
          >
            ...
            <Popover
              ...
              renderPopover={
                <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                  <Link
                    to={path.profile}
                    className='block py-2 px-3 hover:bg-slate-100 hover:text-cyan-500'
                  >
                    Tài khoản của tôi
                  </Link>
                  <Link
                  ...
                  <button
                    className='block w-full py-2 px-3 text-left hover:bg-slate-100 hover:text-cyan-500'
